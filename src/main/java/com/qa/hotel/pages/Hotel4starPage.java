...
public class Hotel4starPage extends BasePage {
	WebDriver driver;
	ElementUtil elementUtil;

	By submit = By.id("f-label-star-rating-4");
	...
	public Hotel4starPage(WebDriver driver) {
		this.driver = driver;
		elementUtil = new ElementUtil(driver);
	}

	public String getHotel4starPageTitle() {
		System.out.println(driver.getTitle());
		return driver.getTitle();

	}

	public void chose4starHotel() throws InterruptedException {
		...
		((JavascriptExecutor) driver).executeScript("window.scrollBy(0,3000)", "");
			...
			if (radius < 10) {
				System.out.println("4 start hotel is " + hotelList.get(i).getText() + " " + radius);
			}
		}

	}

	public Hotel5starPage switchPage() throws InterruptedException {

		return new Hotel5starPage(driver);
	}
